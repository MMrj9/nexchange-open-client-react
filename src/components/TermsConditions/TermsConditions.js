        ...
        <div className="container">
          <div className="row">
            <div className="col-xs-12" style={{ marginTop: 80 }}>
                ...
                <p>CryptoFX is an Exchange which allows you to exchange crypto and fiat currencies with the best exchange rate. Terms “We”, “Exchange”, “Exchange operator” refer to CryptoFX.</p>
                ...
                <p>Transactions cannot be canceled by CryptoFX. Therefore, check your payment details before making transaction. CryptoFX is not responsible for your coins once they have been sent to the wallet.</p>
                <p>CryptoFX doesn’t guarantee the uptime of the exchange. Maintenance and downtime may be required at times.</p>
                ...
                <p>You are prohibited from using or accessing CryptoFX from the following jurisdictions</p>
                <ol>
                  <li>New York State</li>
                  <li>Washington State</li>
                  <li>North Korea</li>
                </ol>
                <p>Transactions from users in these jurisdictions are prohibited, and CryptoFX may seize any funds from users in these jurisdictions. By accessing this site or any services therein, you represent and warrant that you are not physically located in these prohibited jurisdictions.</p>
                <h3>Refund Policy</h3>
